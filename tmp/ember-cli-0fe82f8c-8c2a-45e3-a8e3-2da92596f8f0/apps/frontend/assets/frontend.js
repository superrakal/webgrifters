...
define('frontend/components/infinite-scroll-container', ['exports', 'ember-cli-infinite-scroll/components/infinite-scroll-container'], function (exports, InfiniteScrollContainer) {
...
define('frontend/components/infinite-scroll', ['exports', 'ember-cli-infinite-scroll/components/infinite-scroll'], function (exports, InfiniteScroll) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    var child1 = (function() {
      ...
      return {
        ...
        statements: [
          ["block","link-to",["add"],[],0,null,["loc",[null,[1,1477],[1,1618]]]]
        ],
        locals: [],
        templates: [child0]
      };
    ...
    return {
      ...
      buildRenderNodes: function buildRenderNodes(dom, fragment, contextualElement) {
        ...
        morphs[2] = dom.createMorphAt(dom.childAt(element6, [1, 0]),0,0);
        return morphs;
      },
      statements: [
        ["block","each",[["get","model",["loc",[null,[1,485],[1,490]]]]],[],0,null,["loc",[null,[1,477],[1,1251]]]],
        ["inline","infinity-loader",[],["infinityModel",["subexpr","@mut",[["get","model",["loc",[null,[1,1289],[1,1294]]]]],[],[]],"loadingText","Идет подгрузка данных...","loadedText","Все данные подгружены"],["loc",[null,[1,1257],[1,1370]]]],
        ["block","if",[["get","session.isLoggedIn",["loc",[null,[1,1457],[1,1475]]]]],[],1,2,["loc",[null,[1,1451],[1,1802]]]]
      ],
      locals: [],
